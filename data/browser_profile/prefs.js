...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1781089971);
user_pref("app.update.lastUpdateTime.background-update-timer", 1781089971);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1781089971);
user_pref("app.update.lastUpdateTime.glean-addons-daily", 1781089971);
user_pref("app.update.lastUpdateTime.region-update-timer", 1781089971);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1781342239);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1781089971);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1781089971);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "1e76d9ee-eea6-496f-9fc3-ec3071017ca9");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1779518397);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{0a7260d7-b2f4-497c-8372-8802fa7a640b}");
...
user_pref("browser.startup.lastColdStartupCheck", 1781342239);
...
user_pref("browser.urlbar.lastUrlbarSearchSeconds", 1779531162);
...
user_pref("captchadetection.lastSubmission", 1781089);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "876fd423-f8da-4419-a7f2-835902b3a84a");
user_pref("datareporting.dau.cachedUsageProfileID", "503827e8-b5c4-417e-af99-02e67099ab4f");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"882e5909-c042-41c4-8699-929652372bbe\",\"formautofill@mozilla.org\":\"9c585c9d-4b3e-44fc-9f14-a02ce664aaa8\",\"ipp-activator@mozilla.com\":\"321b79d3-996a-4527-a6bf-4b5dd99b1d0c\",\"pictureinpicture@mozilla.org\":\"cddbcd75-f4c8-4b2e-855f-b52e942ed616\",\"addons-search-detection@mozilla.com\":\"de1e73db-d257-43e0-8f5d-1888173c7875\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"fc35adf9-d138-415c-bf1b-19c42476ccfe\",\"default-theme@mozilla.org\":\"c8cadac2-20b4-412a-9219-ac7989aa7c98\"}");
...
user_pref("idle.lastDailyNotification", 1780396416);
...
user_pref("media.gmp-manager.lastCheck", 1781089997);
user_pref("media.gmp-manager.lastEmptyCheck", 1781089997);
...
user_pref("nimbus.profileId", "eebcc74a-ad9a-46fb-bfc3-e06bbb4d901c");
user_pref("pdfjs.disabled", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1780219002);
user_pref("plugin.state.flash", 0);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.clearOnShutdown_v2.formdata", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1780396416805");
...
user_pref("storage.vacuum.last.content-prefs.sqlite", 1780396416);
user_pref("storage.vacuum.last.index", 1);
user_pref("storage.vacuum.last.places.sqlite", 1780219002);
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "5009f5e2");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1781342235);
